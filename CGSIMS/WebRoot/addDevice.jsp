...
<body class="container-fluid">
		...
		<table class="table table-bordered">
				...
				<c:forEach items="${deviceStoragePage.list}" var="device">
					<tr>
						...
						<td>${device.device_attri}</td>
						<td>
							<button type="button" class="btn btn-default  btn-sm">
								<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
								修改
							</button>
							<button type="button" class="btn btn-default btn-sm" onclick='delWarning("+${device.device_id}+")' style="color: red">
	...
	<script src="../assets/js/delWarning.js"></script>
</body>
</html>